...
<template>
    <div>
        ...
        >
            <!-- <ApplicationLogo class="block h-12 w-auto mb-12" /> -->

            <p class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
                Build your ultimate car collection with Daydream Garage, the
                premier tool for browsing, saving, and sharing cars from online
                marketplaces. Whether you’re a seasoned car enthusiast, a casual
                browser, or someone on the hunt for their next dream ride,
                Daydream Garage is designed to elevate your car-shopping
                experience. Seamlessly explore a vast array of vehicles from the
                comfort of your home, organize your favorite finds in
                personalized collections, and share your top picks with friends
                and fellow car lovers. Start your journey with Daydream Garage
                today and turn your automotive dreams into reality.
            </p>
        </div>
